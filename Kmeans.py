...
def plot():
    ...
    if u=='clustered':
        plot1 = fig.add_subplot(111)
        plt.scatter(file[X_Axis.get()], file[Y_Axis.get()],c=labs,cmap='rainbow')
        plt.show()
...
def files():
    with open(r"C:\Users\MAHE\Downloads\Tkinter_Module\Summary\model_summary","w",encoding="utf-8") as file:
