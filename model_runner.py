...
def KNC():
    os.startfile(r"C:\Users\MAHE\Downloads\Tkinter_Module\final_project\models\KNC.py",operation="open")

def Kmeans():
    os.startfile(r"C:\Users\MAHE\Downloads\Tkinter_Module\final_project\models\Kmeans.py",operation="open")

def NBCls():
    os.startfile(r"C:\Users\MAHE\Downloads\Tkinter_Module\final_project\models\NaiveBayes.py",operation="open")

def SVMCls():
    os.startfile(r"C:\Users\MAHE\Downloads\Tkinter_Module\final_project\models\SVM-Clas.py",operation="open")

def SVMReg():
    os.startfile(r"C:\Users\MAHE\Downloads\Tkinter_Module\final_project\models\SVM-Reg.py",operation="open")

def Lasso():
    os.startfile(r"C:\Users\MAHE\Downloads\Tkinter_Module\final_project\models\Lasso Reg.py",operation="open")

def Ridge():
    os.startfile(r"C:\Users\MAHE\Downloads\Tkinter_Module\final_project\models\Ridge Reg.py",operation="open")

def LinReg():
    os.startfile(r"C:\Users\MAHE\Downloads\Tkinter_Module\final_project\models\LinearReg.py",operation="open")

def LogReg():
    os.startfile(r"C:\Users\MAHE\Downloads\Tkinter_Module\final_project\models\LogisticReg.py",operation="open")

def MLPCls():
    os.startfile(r"C:\Users\MAHE\Downloads\Tkinter_Module\final_project\models\MLP Cls.py",operation="open")

def DecReg():
    os.startfile(r"C:\Users\MAHE\Downloads\Tkinter_Module\final_project\models\Decision - Reg.py",operation="open")
